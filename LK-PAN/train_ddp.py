...
parser.add_argument('--batch-size-eval', default=16, type=int,
                    metavar='N',
                    help='mini-batch size (default: 128), this is the total '
                         'batch size of all GPUs on the current node when '
                         'using Data Parallel or Distributed Data Parallel')
...
def main():
    ...
    if args.dataset == 'university':
        args.query_folder_train = '/data3/limian1/Documents/LPN-main/data/University-Release/train/satellite'
        args.gallery_folder_train = '/data3/limian1/Documents/LPN-main/data/University-Release/train/drone'
        args.query_folder_test = '/data3/limian1/Documents/LPN-main/data/University-Release/test/query_satellite'
        args.gallery_folder_test = '/data3/limian1/Documents/LPN-main/data/University-Release/test/gallery_drone'
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset.lower() == "university":
        ...
        if args.dis_sample:
            ...
            gallery_dataset_train = DenseUAVEval(data_folder=args.gallery_folder_train,
                                                 mode="gallery",
                                                 transforms=val_transforms,
                                                 )
            ...
            query_dataset_train = DenseUAVEval(data_folder=args.query_folder_train,
                                               mode="query",
